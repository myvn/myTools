...
export const arrObjSum5 = (obj) => {
    return obj.reduce((prev, cur) => prev + cur.key, 0)
}
export const arrObjSum6 = (obj) => {
    return obj.reduce((prev, cur) => prev + cur.key, 0)
}
export const arrObjSum7 = (obj) => {
    return obj.reduce((prev, cur) => prev + cur.key, 0)
}
...
export const sessionStorageSetExpire_1_10 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_2 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_3 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_4 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_5 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_6 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_7 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_8 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_1_9 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_9 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_8 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_7 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_6 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_5 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_4 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
...
export const sessionStorageSetExpire_2_3 = (key, value, expire) => {
    if (typeof (value) === 'object') value = JSON.stringify(value)
    sessionStorage.setItem(key, value)
    setTimeout(() => {
        sessionStorage.removeItem(key)
